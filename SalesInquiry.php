...
//		echo '<br/><br/>';
		if ($_POST['ReportType'] == 'Detail') {
		    if ($_POST['DateType'] == 'Order') {
				printf('<tr><th>%10s</th><th>%-20s</th><th>%10s</th><th>%-10s</th><th>%-30s</th><th>%-30s</th><th>%12s</th><th>%14s</th><th>%14s</th><th>%14s</th><th>%12s</th><th>%-10s</th><th>%-10s</th><th>%-10s</th><th>%-40s</th></tr>',
					 _('Order No'),
					 _('Stock Code'),
					 _('Order Date'),
					 _('Debtor No'),
				...
				printf('<tr><th>%10s</th><th>%14s</th><th>%-20s</th><th>%10s</th><th>%-10s</th><th>%-30s</th><th>%-30s</th><th>%12s</th><th>%14s</th><th>%14s</th><th>%12s</th><th>%-10s</th><th>%-10s</th><th>%-10s</th><th>%-40s</th></tr>',
					 _('Order No'),
					 _('Trans. No'),
					 _('Stock Code'),
					 _('Order Date'),
...
//			print '<br/><br/>';
			...
			while ($myrow = DB_fetch_array($result)) {
			    ...
			    $linectr++;
			    if ($_POST['DateType'] == 'Order') {
					printf('<tr'.$SomeClass.'><td>%10s</td><td>%-20s</td><td>%10s</td><td>%-10s</td><td>%-30s</td><td>%-30s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%14s</td><td>%12s</td><td>%-10s</td><td>%-10s</td><td>%-10s</td><td>%-40s</td></tr>',
					$myrow['orderno'],
					$myrow['stkcode'],
					...
					printf('<tr'.$SomeClass.'><td>%10s</td><td>%14s</td><td>%-20s</td><td>%10s</td><td>%-10s</td><td>%-30s</td><td>%-30s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%12s</td><td>%-10s</td><td>%-10s</td><td>%-10s</td><td>%-40s</td></tr>',
					$myrow['orderno'],
					$myrow['transno'],
					$myrow['stkcode'],
					ConvertSQLDate($myrow['orddate']),
			...
			// Print totals
			if ($_POST['DateType'] == 'Order') {
					printf('<tr><td>%10s</td><td>%-20s</td><td>%10s</td><td>%-10s</td><td>%-30s</td><td>%-30s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%14s</td><td>%12s</td><td>%-10s</td><td>%-40s</td></tr>',
					_('Totals'),
					_('Lines - ') . $linectr,
					' ',
					' ',
			  ...
			  // Print totals for Invoiced Date Type - Don't print invoice quantity
					printf('<tr><td>%10s</td><td>%14s</td><td>%-20s</td><td>%10s</td><td>%-10s</td><td>%-30s</td><td>%-30s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%12s</td><td>%10s</td><td>%-40s</td></tr>',
					_('Totals'),
					_('Lines - ') . $linectr,
					' ',
					' ',
		  ...
		  // Print summary stuff
			...
			printf('<tr><th>%-30s</th><th>%-40s</th><th>%12s</th><th>%14s</th><th>%14s</th><th>%14s</th><th>%-15s</th></tr>',
				 _($SummaryHeader),
				 _($Descriptionheader),
				 _('Quantity'),
				 _('Extended Cost'),
...
//			print '<br/><br/>';
			...
			while ($myrow = DB_fetch_array($result)) {
				...
				printf('<tr'.$SomeClass.'><td>%-30s</td><td>%-40s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%14s</td><td> %-40s</td></tr>',
				$myrow[$SummaryType],
				$myrow[$Description],
...
//				print '<br/>';
			...
			// Print totals
			printf('<tr><td>%-30s</td><td>%-40s</td><td>%12s</td><td>%14s</td><td>%14s</td><td>%14s</td></tr>',
			_('Totals'),
			_('Lines - ') . $linectr,
			locale_number_format($TotalQty,2),
			locale_number_format($TotalExtCost,$_SESSION['CompanyRecord']['decimalplaces']),
