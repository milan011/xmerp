  ...
  */
	...
	// it is a supplier payment by cheque and haven't printed yet so print cheque
	  ...
	  /*Its a supplier payment type 22 */
			...
			$_SESSION['PaymentDetail' . $identifier]->Narrative = $_SESSION['PaymentDetail' . $identifier]->SuppName . '[' . $_SESSION['PaymentDetail' . $identifier]->SupplierID . ']-' . $_SESSION['PaymentDetail' . $identifier]->Narrative;
