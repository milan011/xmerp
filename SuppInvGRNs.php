...
/* $Id: SuppInvGRNs.php 6455 2013-11-29 07:30:02Z daintree $*/
...
foreach ($_SESSION['SuppTrans']->GRNs as $EnteredGRN){
	...
	echo '<tr>
			...
			<td><input type="text" class="number" name="ChgPrice' . $i . '" value="' . locale_number_format($EnteredGRN->ChgPrice,10) . '" size="11" maxlength="10" /></td>
...
echo '</tbody>
	...
	<div class="centre">
		<p>
			<input type="submit" name="ModifyGRN" value="' . _('Update Amounts Invoiced') . '" />
		</p>
	</div>
	<br />
	<div class="centre">
