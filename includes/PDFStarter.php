...
//	this should have been done whith FPDF which use the same values in its constructor.
  ...
  case 'A4_Landscape':
   ...
   case 'P/3/A4_pingzheng':
	...
	$DocumentPaper = 'Z2'; $DocumentOrientation ='L';
	...
	$DocumentPaper = 'Z1'; $DocumentOrientation ='L';
...
$pdf->addInfo('Creator', 'cncERP http://www.cncerp.com');
$pdf->addInfo('Author', 'cncERP ' . $Version);
