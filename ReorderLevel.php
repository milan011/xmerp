...
/* $Id: ReorderLevel.php 5785 2012-12-29 04:47:42Z daintree $*/
...
if (isset($_POST['PrintPDF'])) {
	...
	while ($myrow = DB_fetch_array($result,$db)){
		...
		$pdf->addTextWrap(410,$YPos,60,$FontSize,$myrow['locationname'],'left',0,$fill);
		...
		while ($myrow2 = DB_fetch_array($OtherResult,$db)){
			...
			$pdf->addTextWrap(410,$YPos,60,$FontSize,$myrow2['locationname'],'left',0,$fill);
