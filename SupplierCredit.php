...
/* $Id: SupplierCredit.php 6264 2013-08-20 03:26:29Z exsonqu $ */
			...
			*/
			...
			the debit is to creditors control act  done later for the total credit note value + tax*/
				...
				$SQL = "INSERT INTO gltrans (type,
								 	...
								 	VALUES (21,
										...
										'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . "] " . $EnteredGLCode->Narrative . "',
			...
			these entries are reversed from the GRN suspense when the shipment is closed - entries only to open shipts*/
				...
				$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (21,
									...
									'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] ' .	 _('Shipment credit against') . ' ' . $ShiptChg->ShiptRef . "',
			...
			foreach ($_SESSION['SuppTrans']->Assets as $AssetAddition){
				...
				$SQL = "INSERT INTO gltrans (type,
									...
									VALUES ('21',
										...
										'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] ' . _('Asset Credit') . ' ' . $AssetAddition->AssetID . ': '  . $AssetAddition->Description . "',
			 ...
			 * the WIP account is tidied up when the contract is closed*/
				...
				$SQL = "INSERT INTO gltrans (type,
							...
							VALUES (21,
								...
								'" . $PeriodNo . "',
								'". $WIPAccount . "',
								'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] ' . _('Contract charge against') . ' ' . $Contract->ContractRef . "',
					...
					if ($EnteredGRN->StdCostUnit * $EnteredGRN->This_QuantityInv != 0) {
						$SQL = "INSERT INTO gltrans (type,
								...
								VALUES ('21',
									...
									'" . $PeriodNo . "',
									'" . $_SESSION['SuppTrans']->GRNAct . "',
									'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('GRN Credit Note') . ' ' . $EnteredGRN->GRNNo . ' - ' . $EnteredGRN->ItemDescription.'['.$EnteredGRN->ItemCode . '] x ' . $EnteredGRN->This_QuantityInv . ' @  ' . _('std cost of') . ' ' . $EnteredGRN->StdCostUnit  . "',
                  ...
                  $PurchPriceVar = $EnteredGRN->This_QuantityInv * (($EnteredGRN->ChgPrice  / $_SESSION['SuppTrans']->ExRate) - $EnteredGRN->StdCostUnit);
							...
							if ($_SESSION['WeightedAverageCosting']==1){ /*Weighted Average costing */
								...
								*/
									...
									* (($EnteredGRN->ChgPrice  / $_SESSION['SuppTrans']->ExRate) - $EnteredGRN->StdCostUnit);
									...
									$SQL = "INSERT INTO gltrans (type,
														...
														VALUES (21,
															...
															'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('GRN Credit Note') . ' ' . $EnteredGRN->GRNNo .' - ' . $EnteredGRN->ItemDescription.'['.$EnteredGRN->ItemCode . '] x ' . ($EnteredGRN->This_QuantityInv-$TotalQuantityOnHand) . ' x  ' . _('price var of') . ' ' . locale_number_format(($EnteredGRN->ChgPrice  / $_SESSION['SuppTrans']->ExRate) - $EnteredGRN->StdCostUnit,$_SESSION['CompanyRecord']['decimalplaces'])  ."',
															'" . (-$WriteOffToVariances) . "')";
								...
								$SQL = "INSERT INTO gltrans (type,
												...
												'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('Average Cost Adj') .
												' - ' . $EnteredGRN->ItemDescription.'['.$EnteredGRN->ItemCode . '] x ' . $TotalQuantityOnHand  . ' x ' .
						...
						the goods were received */
							...
							$SQL = "INSERT INTO gltrans (type,
										...
										VALUES (21,
											...
											'" . $PeriodNo . "',
											'" . $GLCode . "',
											'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('GRN') . ' ' . $EnteredGRN->GRNNo . ' - ' . $EnteredGRN->ItemDescription.'['.$EnteredGRN->ItemCode . '] x ' . $EnteredGRN->This_QuantityInv . ' x  ' . _('price var') .
									 ' ' . locale_number_format(($EnteredGRN->ChgPrice  / $_SESSION['SuppTrans']->ExRate) - $EnteredGRN->StdCostUnit,$_SESSION['CompanyRecord']['decimalplaces']) . "',
											'" . (-$PurchPriceVar) . "')";
					...
					$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (
									...
									'" . $PeriodNo . "',
									'" . $_SESSION['SuppTrans']->GRNAct . "',
									'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('GRN') .' ' . $EnteredGRN->GRNNo . ' - ' . $EnteredGRN->ItemDescription.'['.$EnteredGRN->ItemCode . '] x ' . $EnteredGRN->This_QuantityInv . ' @ ' . $_SESSION['SuppTrans']->CurrCode .' ' . $EnteredGRN->ChgPrice . ' @ ' . _('a rate of') . ' ' . $_SESSION['SuppTrans']->ExRate . "',
				...
				if ($Tax->TaxOvAmount/ $_SESSION['SuppTrans']->ExRate !=0){
					$SQL = "INSERT INTO gltrans (type,
							...
							VALUES (21,
								...
								'" . $PeriodNo . "',
								'" . $Tax->TaxGLCode . "',
								'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('Credit note') . ' ' . $_SESSION['SuppTrans']->SuppReference . ' ' . $_SESSION['SuppTrans']->CurrCode . $Tax->TaxOvAmount  . ' @ ' . _('a rate of') . ' ' . $_SESSION['SuppTrans']->ExRate . "',
			...
			$SQL = "INSERT INTO gltrans (type,
					 ...
					 VALUES (21,
						...
						'" . $SupplierName.'['.$_SESSION['SuppTrans']->SupplierID . '] - ' . _('Credit Note') . ' ' . $_SESSION['SuppTrans']->SuppReference . ' ' .  $_SESSION['SuppTrans']->CurrCode . locale_number_format($_SESSION['SuppTrans']->OvAmount + $_SESSION['SuppTrans']->OvGST,$_SESSION['SuppTrans']->CurrDecimalPlaces)  . ' @ ' . _('a rate of') . ' ' . $_SESSION['SuppTrans']->ExRate .  "',
