...
/* $Id: StockAdjustments.php 6310 2013-08-29 10:42:50Z daintree $*/
		...
		if ($_SESSION['CompanyRecord']['gllink_stock']==1 AND $_SESSION['Adjustment' . $identifier]->StandardCost > 0){
			...
			$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (17,
									...
									'" . $_SESSION['Adjustment' . $identifier]->ItemDescription . " x " . $_SESSION['Adjustment' . $identifier]->Quantity . " @ " .
			...
			$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (17,
									...
									'" . round($_SESSION['Adjustment' . $identifier]->StandardCost * $_SESSION['Adjustment' . $identifier]->Quantity,$_SESSION['CompanyRecord']['decimalplaces']) . "',
									'" . $_SESSION['Adjustment' . $identifier]->ItemDescription . ' x ' . $_SESSION['Adjustment' . $identifier]->Quantity . ' @ ' . $_SESSION['Adjustment' . $identifier]->StandardCost . ' ' . $_SESSION['Adjustment' . $identifier]->Narrative . "',
									'" . $_SESSION['Adjustment' . $identifier]->tag . "'
									)";
