<?php
/* $Id: CounterReturns.php 4469 2011-01-15 02:28:37Z daintreee $*/
...
*/
	...
	echo '<tr>
			<td style="color:red">' . _('Banked Paid to') . ':</td>
		...
		/*first the cost of sales entry*/
				...
				$SQL = "INSERT INTO gltrans (	type,
										...
										VALUES ( 11,
												...
												'" . $_SESSION['Items' . $identifier]->CustomerName . " - " . $ReturnItemLine->ItemDescription . " x " . -$ReturnItemLine->Quantity . " @ " . $ReturnItemLine->StandardCost . "',
												'" . $ReturnItemLine->StandardCost * -$ReturnItemLine->Quantity . "')";
		...
		//Post sales transaction to GL credit sales
				...
				$SQL = "INSERT INTO gltrans (type,
										...
										VALUES ( 11,
											...
											'" . $_SESSION['Items' . $identifier]->CustomerName . " - " . $ReturnItemLine->ItemDescription . " x " . -$ReturnItemLine->Quantity . " @ " . $ReturnItemLine->Price . "',
											'" . ($ReturnItemLine->Price * $ReturnItemLine->Quantity/$ExRate) . "')";
				...
				if ($ReturnItemLine->DiscountPercent !=0){
					...
					$SQL = "INSERT INTO gltrans (type,
												...
												VALUES ( 11,
													...
													'" . $_SESSION['Items' . $identifier]->CustomerName . " - " . $ReturnItemLine->ItemDescription . " @ " . ($ReturnItemLine->DiscountPercent * 100) . "%',
