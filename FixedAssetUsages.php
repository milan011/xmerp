...
/*if(isset($_GET['rtn'])){
	$_POST['AssetCat']=$_SESSION['Usages_AssetCat'];
	$_POST['Keywords']=$_SESSION['Usages_Keywords'];
	$_POST['AssetID']=$_SESSION['Usages_AssetID'];
	$_POST['Search']='';
}*/
if(!isset($_POST['AssetCat'])){
	$_POST['AssetCat']=$_SESSION['Usages_AssetCat'];
}else{
	$_SESSION['Usages_AssetCat']=$_POST['AssetCat'];
}
if(!isset($_POST['Keywords'])){
	$_POST['Keywords']=$_SESSION['Usages_Keywords'];
}else{
	$_SESSION['Usages_Keywords']=$_POST['Keywords'];
}
if(!isset($_POST['AssetID'])){
	$_POST['AssetID']=$_SESSION['Usages_AssetID'];
}else{
	$_SESSION['Usages_AssetID']=$_POST['AssetID'];
}
$_POST['Search']='';
...
//	$_SESSION['Usages_AssetID']=$_POST['AssetID'];
	...
	$sql= "SELECT fixedassets.assetid,
				...
				ORDER BY fixedassets.lastupdate DESC";//AND fixedassets.serialno " . LIKE . "'".$_POST['SerialNumber']."'
