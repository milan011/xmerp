...
/* $Id: ReverseGRN.php 6310 2013-08-29 10:42:50Z daintree $*/
	...
	First the credit using the GLCode in the PO detail record entry*/
		...
		$SQL = "INSERT INTO gltrans (type,
								...
								VALUES (
									...
									'" . $PeriodNo . "',
									'" . $GRN['glcode'] . "',
									'" . _('GRN Reversal for PO') .": " . $GRN['orderno'] . " " . $_POST['SuppName'] . " - " . $GRN['itemcode'] . "-" . $GRN['itemdescription'] . " x " . $QtyToReverse . " @ " . locale_number_format($GRN['stdcostunit'],$_SESSION['CompanyRecord']['decimalplaces']) . "',
									'" . -($GRN['stdcostunit'] * $QtyToReverse) . "')";
...
/*now the GRN suspense entry*/
		$SQL = "INSERT INTO gltrans (type,
							...
							VALUES (
								...
								. _('GRN Reversal PO') . ': ' . $GRN['orderno'] . " " . $_POST['SuppName'] . " - " . $GRN['itemcode'] . "-" . $GRN['itemdescription'] . " x " . $QtyToReverse . " @ " . locale_number_format($GRN['stdcostunit'],$_SESSION['CompanyRecord']['decimalplaces']) . "',
								'" . $GRN['stdcostunit'] * $QtyToReverse . "'
								)";
