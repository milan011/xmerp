<?php
/* $Id: Credit_Invoice.php 6310 2013-08-29 10:42:50Z daintree $*/
			...
			if ($_POST['CreditType']=='Return'){
				...
				if ($CreditLine->MBflag=='M' oR $CreditLine->MBflag=='B'){
					...
					while ($AssParts = DB_fetch_array($AssResult,$db)){
						//$StandardCost += $AssParts['standard']; orig
...
/*first the cost of sales entry*/
				...
				$SQL = "INSERT INTO gltrans (type,
						...
						VALUES (11,
							...
							'" . $PeriodNo . "',
							'" . $COGSAccount . "',
							'" . $_SESSION['CreditItems' . $identifier]->CustomerName . " - " . $CreditLine->ItemDescription . " x " . $CreditLine->QtyDispatched . " @ " . round($CreditLine->StandardCost,$_SESSION['CompanyRecord']['decimalplaces']) . "',
...
//Post sales transaction to GL credit sales
				...
				$SQL = "INSERT INTO gltrans (type,
					...
					VALUES (11,
						...
						'" . $_SESSION['CreditItems' . $identifier]->CustomerName . " - " . $CreditLine->ItemDescription . " x " . $CreditLine->QtyDispatched . " @ " . $CreditLine->Price . "',
