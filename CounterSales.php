		...
		/*first the cost of sales entry*/
				...
				$SQL = "INSERT INTO gltrans (	type,
										...
										VALUES ( 10,
												...
												'" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " x " . $OrderLine->Quantity . " @ " . $OrderLine->StandardCost . "',
												'" . $OrderLine->StandardCost * $OrderLine->Quantity . "')";
		...
		//Post sales transaction to GL credit sales
				...
				$SQL = "INSERT INTO gltrans (type,
										...
										VALUES ( 10,
											...
											'" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " x " . $OrderLine->Quantity . " @ " . $OrderLine->Price . "',
											'" . (-$OrderLine->Price * $OrderLine->Quantity/$ExRate) . "')";
				...
				if ($OrderLine->DiscountPercent !=0){
					...
					$SQL = "INSERT INTO gltrans (type,
												...
												VALUES ( 10,
													...
													'" . $_SESSION['Items'.$identifier]->CustomerName . " - " . $OrderLine->ItemDescription . " @ " . ($OrderLine->DiscountPercent * 100) . "%',
			...
			if (($_SESSION['Items'.$identifier]->total + filter_number_format($_POST['TaxTotal'])) !=0) {
				$SQL = "INSERT INTO gltrans (	type,
											...
											VALUES ( 10,
												...
												'" . $_SESSION['Items'.$identifier]->CustomerName . "',
			...
			if ($_POST['AmountPaid']!=0){
				...
				$SQL="INSERT INTO gltrans (type,
						...
						VALUES (12,
							...
							'" . $PeriodNo . "',
							'" . $_POST['BankAccount'] . "',
							'" . $_SESSION['Items'.$identifier]->LocationName . ' ' . _('Counter Sale') . ' ' . _('Invoice number').':'. $InvoiceNo . "',
			...
			*/
			...
			$SQL="INSERT INTO banktrans (type,
					...
					VALUES (12,
						...
						'" . $BankAccountExRate . "',
						'" . $DefaultDispatchDate . "',
						(SELECT paymentname FROM paymentmethods where paymentid='" . $_POST['PaymentMethod'] . "'),
...
if (!isset($_POST['ProcessSale'])){
	...
	// Find the quantity in stock at location
			...
			echo '<td style="text-align:center" colspan="8"><input tabindex="'.strval($j+8).'" type="submit" value="'._('Add to Sale').'" name="SelectingOrderItems"/></td>';
			echo '</table>';
	...
	// Add some useful help as the order progresses
		...
		if (isset($SearchResult)) {
			...
			echo '<tr>
					...
					<td style="text-align:center" colspan="6"><input tabindex="'.strval($j+8).'" type="submit" value="'._('Add to Sale').'" name="SelectingOrderItems"/></td>
            ...
            echo '<tr>
				...
				<tr>
					<td><input tabindex="' . strval($j+7) . '" type="submit" name="Previous" value="' . _('Prev') . '" /></td>
					<td style="text-align:center" colspan="6"><input tabindex="'.strval($j+8).'" type="submit" value="'._('Add to Sale').'" name="SelectingOrderItems"/></td>
					<td><input tabindex="'.strval($j+9).'" type="submit" name="Next" value="'._('Next').'" /></td>
				</tr>
				</table>
				</div>';
