...
if (isset($_POST['PrintPDF'])) {
	...
	while ($LowGPItems = DB_fetch_array($LowGPSalesResult,$db)){
		...
		$LeftOvers = $pdf->addTextWrap($Left_Margin+2,$YPos,100-$Left_Margin,$FontSize,$LowGPItems['typename']);
		$LeftOvers = $pdf->addTextWrap(100,$YPos,50,$FontSize,$LowGPItems['transno']);
		$LeftOvers = $pdf->addTextWrap(130,$YPos,150,$FontSize,$LowGPItems['description']);
		$LeftOvers = $pdf->addTextWrap(220,$YPos,130,$FontSize,$LowGPItems['name']);
